// Command bootstrap performs the ONE-TIME Operator initialization.
// Run this exactly once per environment. The output is the source of
// truth for OPERATOR_SEED and SYSTEM_ACCOUNT_SEED; copy them to .env.
// No network call to NATS is made.
package main
